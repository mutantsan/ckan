...
def load_environment(conf: Union[Config, CKANConfig]):
    ...
    valid_base_public_folder_names = ["public", "public-midnight-blue", "public-tw"]
...
def update_config() -> None:
    ...
    if errors:
        msg = "\n".join(
            "{}: {}".format(key, "; ".join(issues)) for key, issues in errors.items()
        )
    ...
    valid_base_templates_folder_names = [
        "templates",
        "templates-midnight-blue",
        "templates-tw",
    ]
